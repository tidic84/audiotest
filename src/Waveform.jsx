        ...
        {fileExists ? (
          <Box
            sx={{
              position: "relative",
              width:
                actualDuration || mainTrackRef?.current?.clientWidth || "100%",
          ...
          >
            ...
            <div
              ref={waveformRef}
              onClick={
                !isMainTrack && enableRegions ? handleContainerClick : undefined
              }
              style={{
                width: "100%",
                height: "100%",
